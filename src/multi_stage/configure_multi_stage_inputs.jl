...
"""
function configure_multi_stage_inputs(inputs_d_all::Dict, settings_d::Dict, NetworkExpansion::Int64)
	...
	inputs_d = inputs_d_all[cur_stage];

	inputs_d["pTrans_Max"] = inputs_d_all[1]["pTrans_Max"];
        
	inputs_d["dfGen"][inputs_d["dfGen"].New_Build .!=-1,:Existing_Cap_MW] = inputs_d_all[1]["dfGen"][inputs_d["dfGen"].New_Build .!=-1,:Existing_Cap_MW];

	inputs_d["dfGen"][inputs_d["dfGen"].New_Build .!=-1,:Existing_Charge_Cap_MW] = inputs_d_all[1]["dfGen"][inputs_d["dfGen"].New_Build .!=-1,:Existing_Charge_Cap_MW];

	inputs_d["dfGen"][inputs_d["dfGen"].New_Build .!=-1,:Existing_Cap_MWh] = inputs_d_all[1]["dfGen"][inputs_d["dfGen"].New_Build .!=-1,:Existing_Cap_MWh];

	inputs_d["dfGen"][!,:Cap_Size] = inputs_d_all[1]["dfGen"][!,:Cap_Size];
